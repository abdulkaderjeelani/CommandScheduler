...
namespace CommandScheduler.Client.CommandSubscribeService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="CommandSubscribeService.ICommandSubscribeService", CallbackContract=typeof(CommandScheduler.Client.CommandSubscribeService.ICommandSubscribeServiceCallback))]
    public interface ICommandSubscribeService {
        ...
        CommandScheduler.Client.CommandSubscribeService.CommandResponse RegisterClientMachine(CommandScheduler.Client.CommandSubscribeService.ClientMachineRegisterInfo regInfo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICommandSubscribeService/RegisterClientMachine", ReplyAction="http://tempuri.org/ICommandSubscribeService/RegisterClientMachineResponse")]
        System.Threading.Tasks.Task<CommandScheduler.Client.CommandSubscribeService.CommandResponse> RegisterClientMachineAsync(CommandScheduler.Client.CommandSubscribeService.ClientMachineRegisterInfo regInfo);
    }
    ...
    public interface ICommandSubscribeServiceCallback {
        ...
        void OnReceiveCommand(CommandScheduler.Client.CommandSubscribeService.CommandInfo command);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICommandSubscribeServiceChannel : CommandScheduler.Client.CommandSubscribeService.ICommandSubscribeService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CommandSubscribeServiceClient : System.ServiceModel.DuplexClientBase<CommandScheduler.Client.CommandSubscribeService.ICommandSubscribeService>, CommandScheduler.Client.CommandSubscribeService.ICommandSubscribeService {
        ...
        public CommandScheduler.Client.CommandSubscribeService.CommandResponse RegisterClientMachine(CommandScheduler.Client.CommandSubscribeService.ClientMachineRegisterInfo regInfo) {
            return base.Channel.RegisterClientMachine(regInfo);
        }
        
        public System.Threading.Tasks.Task<CommandScheduler.Client.CommandSubscribeService.CommandResponse> RegisterClientMachineAsync(CommandScheduler.Client.CommandSubscribeService.ClientMachineRegisterInfo regInfo) {
