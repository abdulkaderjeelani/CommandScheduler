...
namespace CommandScheduler.Application.Ports
{
    ...
    /// </summary>
    public interface ICommandSchedulerRepository
    {
        IEnumerable<ClientMachine> GetAllClients();
        void RemoveClientMachine(ClientMachine clientMachine);
        void SaveClientMachine(ClientMachine clientMachine);
    }
}
