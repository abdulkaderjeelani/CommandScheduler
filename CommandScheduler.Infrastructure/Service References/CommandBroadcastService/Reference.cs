...
namespace CommandScheduler.Infrastructure.CommandBroadcastService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="CommandBroadcastService.ICommandSubscribeService", CallbackContract=typeof(CommandScheduler.Infrastructure.CommandBroadcastService.ICommandSubscribeServiceCallback))]
    public interface ICommandSubscribeService {
        ...
        CommandScheduler.Infrastructure.CommandBroadcastService.CommandResponse RegisterClientMachine(CommandScheduler.Infrastructure.CommandBroadcastService.ClientMachineRegisterInfo regInfo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICommandSubscribeService/RegisterClientMachine", ReplyAction="http://tempuri.org/ICommandSubscribeService/RegisterClientMachineResponse")]
        System.Threading.Tasks.Task<CommandScheduler.Infrastructure.CommandBroadcastService.CommandResponse> RegisterClientMachineAsync(CommandScheduler.Infrastructure.CommandBroadcastService.ClientMachineRegisterInfo regInfo);
    }
    ...
    public interface ICommandSubscribeServiceCallback {
        ...
        void OnReceiveCommand(CommandScheduler.Infrastructure.CommandBroadcastService.CommandInfo command);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICommandSubscribeServiceChannel : CommandScheduler.Infrastructure.CommandBroadcastService.ICommandSubscribeService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CommandSubscribeServiceClient : System.ServiceModel.DuplexClientBase<CommandScheduler.Infrastructure.CommandBroadcastService.ICommandSubscribeService>, CommandScheduler.Infrastructure.CommandBroadcastService.ICommandSubscribeService {
        ...
        public CommandScheduler.Infrastructure.CommandBroadcastService.CommandResponse RegisterClientMachine(CommandScheduler.Infrastructure.CommandBroadcastService.ClientMachineRegisterInfo regInfo) {
            return base.Channel.RegisterClientMachine(regInfo);
        }
        
        public System.Threading.Tasks.Task<CommandScheduler.Infrastructure.CommandBroadcastService.CommandResponse> RegisterClientMachineAsync(CommandScheduler.Infrastructure.CommandBroadcastService.ClientMachineRegisterInfo regInfo) {
    ...
    public interface ICommandBroadcastService {
        ...
        CommandScheduler.Infrastructure.CommandBroadcastService.CommandResponse BroadCastCommand(CommandScheduler.Infrastructure.CommandBroadcastService.CommandInfo command);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICommandBroadcastService/BroadCastCommand", ReplyAction="http://tempuri.org/ICommandBroadcastService/BroadCastCommandResponse")]
        System.Threading.Tasks.Task<CommandScheduler.Infrastructure.CommandBroadcastService.CommandResponse> BroadCastCommandAsync(CommandScheduler.Infrastructure.CommandBroadcastService.CommandInfo command);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICommandBroadcastServiceChannel : CommandScheduler.Infrastructure.CommandBroadcastService.ICommandBroadcastService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CommandBroadcastServiceClient : System.ServiceModel.ClientBase<CommandScheduler.Infrastructure.CommandBroadcastService.ICommandBroadcastService>, CommandScheduler.Infrastructure.CommandBroadcastService.ICommandBroadcastService {
